...
A mobile application backed by [Hospitality-Backend](https://github.com/anmode/Hospitality-Backend) which can be used to find out the nearest hospitals to you in a specific given input range and can be used to check the statistics and the availabilities of the hospitals. Moreover, users can also book appointments with respective hospitals.


### [Hospitality-Backend](https://github.com/anmode/Hospitality-Backend)
